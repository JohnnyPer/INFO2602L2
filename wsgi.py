...
@app.cli.command("change-email", help="Changes the email of a user")
@click.argument('username', default='bob')
...
@app.cli.command('get-todos', help="Retrieves todos")
@click.argument('username', default='bob')
...
@app.cli.command('add-todo',  help="Adds a new task to the todo list")
@click.argument('username', default='bob')
...
@click.argument('username', default='bob')
@app.cli.command('toggle-todo', help ="Lets users toggle the done state of their todo")
